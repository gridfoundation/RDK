...
import (
	...
	furyintconf "github.com/gridfoundation/furyint/config"
	furyintconv "github.com/gridfoundation/furyint/conv"
	furyintnode "github.com/gridfoundation/furyint/node"
	furyintrpc "github.com/gridfoundation/furyint/rpc"
)
...
func startInProcess(ctx *Context, clientCtx client.Context, appCreator types.AppCreator) error {
	...
	ctx.Logger.Info("starting node with ABCI furyint in-process")
	...
	server := furyintrpc.NewServer(tmNode, cfg.RPC, ctx.Logger)
	err = server.Start()
	if err != nil {
		return err
	}
